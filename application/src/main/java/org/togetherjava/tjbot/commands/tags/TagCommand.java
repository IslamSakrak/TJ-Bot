...
public final class TagCommand extends SlashCommandAdapter {
    ...
    private static final String MENTION_USER_OPTION = "reply-to";
    ...
    public TagCommand(TagSystem tagSystem) {
        ...
        getData().addOption(OptionType.STRING, ID_OPTION, "the id of the tag to display", true)
            .addOption(OptionType.USER, MENTION_USER_OPTION,
    ...
    public void onSlashCommand(@NotNull SlashCommandEvent event) {
        ...
        OptionMapping mentionUserOption = event.getOption(MENTION_USER_OPTION);
        ...
        ReplyAction message = event
            .replyEmbeds(new EmbedBuilder().setDescription(tagSystem.getTag(id).orElseThrow())
                ...
                .build());
        if (mentionUserOption != null) {
            message = message.setContent(mentionUserOption.getAsMember().getAsMention());
        }
